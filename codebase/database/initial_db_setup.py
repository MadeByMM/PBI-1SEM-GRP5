...
while inp == 'y':
    ...
    cur.execute("""INSERT INTO materials (material_id, material_name, material_density, material_cost, in_process, for_machine)
                VALUES(2, 'Ultem', 1.27, 343, 3, 2);""")
    cur.execute("""INSERT INTO materials (material_id, material_name, material_density, material_cost, in_process, for_machine)
                VALUES(3, 'Clear Resin', 1.18, 149, 4, 3);""")
    cur.execute("""INSERT INTO materials (material_id, material_name, material_density, material_cost, in_process, for_machine)
                VALUES(4, 'Dental Model Resin', 1.18, 149, 4, 3);""")
    cur.execute("""INSERT INTO materials (material_id, material_name, material_density, material_cost, in_process, for_machine)
                VALUES(5, 'Accura Xtreme', 1.18, 2800, 4, 4);""")
    cur.execute("""INSERT INTO materials (material_id, material_name, material_density, material_cost, in_process, for_machine)
                VALUES(6, 'Casting Resing', 1.18, 299, 4, 3);""")
    cur.execute("""INSERT INTO materials (material_id, material_name, material_density, material_cost, in_process, for_machine)
